...
for(n in 2:10){
  healthPlayerOne[n] <- (healthPlayerOne[n-1] - damagePlayerOne[n-1]) * (1 + playerOne_recovery)
  healthPlayerTwo[n] <- (healthPlayerTwo[n-1] - damagePlayerTwo[n-1]) * (1 + playerTwo_recovery)
}
